...
my_name = "Ata" # Change to your name
my_github_account = "https://github.com/GitHubW1zard" # Change to your GitHub account
my_hobby = "Swimming" # Change to your hobby
hours_coding_per_week = "35" # How many hours per week would you like to devote to learn coding?
