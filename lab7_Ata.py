...
assert remove_duplicates_set("Cherry") == "Chery"
...
def students_id(ids):
    """
    This function returns num of different students who take bus to school
...
assert students_id(['005', '003', '001', '012', '004', '006']) == 6
...
def students_id_occurrences(ids):
    ...
    Returns:
    - (dict): Dictionary with student ids and their num of occurrences
    """
    id_dict = {}
    for id in ids:
        if id in id_dict:
...
assert students_id_occurrences(['002', '003', '002' ,'001', '012', '003', '001']) == {'002': 2, '003': 2, '001': 2, '012': 1}
...
def word_frequency(paragraph):
    ...
    Returns:
    - (dict): Dictionary with words and their num of occurrences
    """
