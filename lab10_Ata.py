...
Your answer is: They have same functionality. Both functions compare numbers in nums list to 'target', if its not equal to 'target' it returns -1, if equal it returns index of the first equal number
...
functionality? Why? (5 marks)
Your answer is: Different functionality. practice_for_index_3 function returns last index of number that equals to "target".
...
# Write your unit tests below
assert more_than_2(["apple", "banana", "apple", "apple", "apple", "pear", "orange",
"banana", "banana", "watermelon"]) == ["apple","banana"]
assert more_than_2(["red", "red", "yellow", "green", "red", "yellow", "orange",
"green", "banana", "yellow"]) == ["red", "yellow"]
