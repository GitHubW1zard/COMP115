...
print(timeofday)
"""
# Made this one little bit defferent, if you dont mind Alice ;)
"""
...
def alarm_time(current_time_string, waiting_time_string):
    return timeofday
if days_passed < 1:
    print("Alarm will ring today","at",alarm_time(any, any), "O'clock")
else:
    print("Alarm will ring after",days_passed,"day" ,"at" ,alarm_time(any, any), "O'clock")
...
assert average([5, 10, 15, 20]) == 12.5
...
assert evens([5,6,7,8,9]) == [6,8]
assert evens([10,11,12,13,14]) == [10,12,14]
...
assert sum_of_squares([5,6,7,8]) == 174
assert sum_of_squares([9,10,11,12]) == 446
...
assert squares([1,3,5,7]) == [1,9,25,49]
